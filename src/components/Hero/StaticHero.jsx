...
export default function StaticHero() {
  // ImageKit کے پیرامیٹرز کو برقرار رکھا ہے
  const heroImageUrl = "https://ik.imagekit.io/ag0dicbdub/uploads/hero6.png?tr=w-800,q-75,f-webp"; 
  ...
  return (
    <section className="relative w-full h-[35vh] md:h-[60vh] overflow-hidden bg-[#0a192f]">
      <Image
        ...
        alt="Wise Mix Media"
        fill
        priority // LCP کے لیے سب سے اہم
        fetchPriority="high"
        decoding="sync"
        className="object-cover object-right md:object-center opacity-70"
        sizes="100vw" // بہتر رسپانسیو کے لیے
      />
      {/* باقی کوڈ ویسے ہی رہے گا */}
      ...
      <div className="relative z-10 container mx-auto h-full px-4 flex items-center justify-center md:justify-start">
        <div className="max-w-xl text-center md:text-left pt-4">
          ...
          <h1 className="text-xl sm:text-3xl md:text-6xl font-black text-white md:text-slate-900 leading-tight">
          ...
          <div className="mt-4 md:mt-6">
            <button className="bg-blue-600 text-white px-5 py-2 md:px-8 md:py-3 rounded-full text-xs md:text-base font-bold shadow-lg active:scale-95">
              Read Articles
            </button>
          </div>
        </div>
